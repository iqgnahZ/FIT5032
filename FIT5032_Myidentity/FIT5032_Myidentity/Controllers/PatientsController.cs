...
namespace FIT5032_Myidentity.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PatientId,FirstName,LastName")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PatientId,FirstName,LastName")] Patient patient)
        {
            if (ModelState.IsValid)
            {
